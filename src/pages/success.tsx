...
export function SuccessScreen({ route, navigation }: any) {
  ...
  return (
    <View className="flex-1 items-center justify-center px-8 bg-gray-50">
      <View className="w-20 h-20 rounded-full bg-habilite-accent items-center justify-center mb-4">
        <Ionicons name="checkmark" size={44} color="#fff" />
      </View>
      <Text className="text-2xl font-extrabold text-habilite-primary">Pedido confirmado!</Text>
      {!!orderId && (
      ...
      >
        <Text className="text-black font-bold">Voltar ao cardápio</Text>
      </Pressable>
